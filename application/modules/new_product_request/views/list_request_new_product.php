...
<div class="modal modal-default fade" id="dialog-popup" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.add_bom', function() {
            var code_lv4 = $(this).data('code_lv4');

            $.ajax({
                type: "post",
                url: siteurl + active_controller + 'add_bom/' + code_lv4,
                data: {
                    'code_lv4': code_lv4
                },
                cache: false,
                beforeSend: function(result) {
                    $('.add_bom_' + code_lv4).html('<i class="fa fa-spin fa-spinner"></i>');
                },
                success: function(result) {
                    $('#myModalLabel').html('<i class="fa fa-plus"></i> Add BOM');
                    $('#ModalView').html(result);
                    $('#dialog-popup').modal();

                    $('.add_bom_' + code_lv4).html('Add BOM');
                },
