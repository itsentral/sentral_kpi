                ...
                <div class="box-body">
                    <div class="col-sm-6 form-horizontal">
					 <div class="row">
                        ...
                        <div class="row">
                          <div class="form-group">
                            ...
                            <div class="col-sm-6" >                             
                              ...
                              <textarea name="alamatcustomer" class="form-control input-sm" id="alamat" height=100 readonly><?php echo $alamat_cust->address_office ?></textarea>
						...
						<div class="row">
                          <div class="form-group">
                              <label for="jenis_invoice" class="col-sm-4 control-label">Bank </font></label>
                              <div class="col-sm-6">
                                 <input type="text" name="bank" id="bank" class="form-control input-sm" value="<?php  echo $nmbank->nama?>" readonly>
                   ...
                   <div class="col-sm-6 form-horizontal">                       
                       ...
                       <div class="form-group ">
						...
						<div class="form-group ">
                            <label for="idsalesman" class="col-sm-4 control-label">Lebih Bayar </label>
                            <div class="col-sm-6" style="padding-top: 8px;">                              
                            <input type="text" name="total_terima" class="form-control input-sm" id="total_terima" value="<?php echo  number_format($data_header->tambah_lebih_bayar,2)?>" readonly>             
					...
					<div class="box-body">
						<form id="form-detail-mutasi" method="post">
							<table class="table table-bordered" width="100%" id="tabel-detail-mutasi">
								...
								<tbody>
									<tr>
										<td class="text-center"><?php echo $inv_det->no_surat ?></td>
