...
class Barcode_single_product extends Admin_Controller
{
    //Permission
    protected $viewPermission 	= 'Barcode_Single_Product.View';
    protected $addPermission  	= 'Barcode_Single_Product.Add';
    protected $managePermission = 'Barcode_Single_Product.Manage';
    protected $deletePermission = 'Barcode_Single_Product.Delete';
   ...
   public function __construct()
    {
        ...
        $this->load->model(array('Barcode_single_product/Barcode_single_product_model'
                                ));
    ...
    public function index(){
      ...
      $this->template->title('Quality Control / QR Code Single Product');
      $this->template->render('index');
    }

    public function data_side_outstanding_qc(){
  		$this->Barcode_single_product_model->data_side_outstanding_qc();
  	}
