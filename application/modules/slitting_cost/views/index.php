<?php
    $ENABLE_ADD     = has_permission('Slitting_cost.Add');
    $ENABLE_MANAGE  = has_permission('Slitting_cost.Manage');
    $ENABLE_VIEW    = has_permission('Slitting_cost.View');
    $ENABLE_DELETE  = has_permission('Slitting_cost.Delete');
?>
          ...
          <div class="box box-primary">
              <div class="box-header">
                <div style="display:inline-block;width:100%;">
                  <a class="btn btn-success" href="<?= base_url('slitting_cost/add_package_cost') ?>" title="Add" style="float:left;margin-right:8px"><i class="fa fa-plus">&nbsp;</i>New</a>
