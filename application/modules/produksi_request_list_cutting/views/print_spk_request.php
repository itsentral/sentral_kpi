...
<table class="gridtable2" width="100%" border='0'>
    <thead>
        ...
        <tr>
            ...
            <td class="mid">Nama Produk</td>
            <td class="mid">:</td>
            <td class="mid"><?=$getData[0]['nama_product'];?></td>
        </tr>
    </thead>
</table><br>
...
<?php
$footer = "<p style='font-family: verdana,arial,sans-serif; font-size:10px;'><i>Printed by : ".ucwords(strtolower($printby)).", ".$today." / Gudang Produksi</i></p>";
