...
<body>
    ...
    <table class="gridtable2" border="0">
        <tr>
            ...
            <td align="right" width="350" valign="top">
                <b style="text-decoration: underline; font-size: 20px;">DOWNPAYMENT</b>
            </td>
        </tr>
    </table>
        ...
        <table class="gridtable2" width="100%" border="1" style="margin-top: 10px;">
            ...
            <tbody>
                ...
                foreach ($data_invoice_detail as $item) {
                    ...
                    $product_code = '';
                    $get_product = $this->db->get_where('new_inventory_4', ['code_lv4' => $item->id_product])->row();
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="left" width="150" style="border: 1px solid black;"><span style="font-weight: bold;">Total DownPayment</span></td>
