...
<div class="box">
	...
	<div class="box-header">
		<div class="nav-tabs-custom">
			...
			<li class=""><a href="#" data-toggle="tab" id="nonrutin">RFQ Department</a></li>
			</ul> 
			</div>			
			<div id="scroll">	
...
<script type="text/javascript">
	...
	function DataAset(){
		 ...
		 $.ajax({
			type:'POST',
			url:siteurl+'pr_selection/list_po_aset',
			success:function(data){
	...
	function DataRutin(){		
		 ...
		 $.ajax({
			type:'POST',
			url:siteurl+'pr_selection/list_perbandingan_rutin',
			success:function(data){
				$("#data").html(data);
				$("#data").fadeIn(500);					
			}
	...
	function DataNonRutin(){		
		 ...
		 $.ajax({
			type:'POST',
			url:siteurl+'pr_selection/list_perbandingan_nonrutin',
			success:function(data){
				$("#data").html(data);
				$("#data").fadeIn(500);					
			}
