          ...
          <div class="box box-primary">
              <div class="box-header">
                <div style="display:inline-block;width:100%;">
                  <a class="btn btn-success" href="<?= base_url('master_supplier/add_supplier') ?>" title="Add" style="float:left;margin-right:8px"><i class="fa fa-plus">&nbsp;</i>New</a>
                   </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
	...
	$(document).on('click', '.edit', function(e){
		...
		$("#head_title").html("<i class='fa fa-list-alt'></i><b> Edit Supplier</b>");
		 		$("#view").load(siteurl+active_controller+'/edit/'+id);
		 $("#ModalView").modal();
	});
