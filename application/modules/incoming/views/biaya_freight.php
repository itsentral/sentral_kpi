...
$suplier	= $this->db->query("SELECT * FROM new_supplier WHERE kode_supplier = '" . $head->id_suplier . "' ")->result();
?>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										...
										<input type="hidden" class="form-control" id="id_data" required name="id_data" value="<?= $head->id_data ?>" readonly placeholder="No.Dokumen">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="id_suplier" required name="id_suplier" value="<?= strtoupper($suplier[0]->name_suplier) ?>" readonly placeholder="id_suplier">
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" value="<?= date('d F Y', strtotime($head->tanggal)); ?>" id="tanggal" required name="tanggal" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="ket" required name="ket" value="<?= $head->keterangan ?>" readonly>
									</div>
								</div>
							</div>
						</div>
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="pic" required name="pic" required value="<?= $head->pic ?>" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input type="text" class="form-control" id="pib" required name="pib" required value="<?= $head->pib ?>" readonly>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-8">
										...
										?>
										<input type="text" class="form-control" id="matauang" required name="matauang" value="<?= $kurs ?>" readonly>
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group row">
									<div class="col-md-4">
										<label for="id_customer">Biaya Freight</label>
									</div>
									<div class="col-md-8">
										<input type="text" class="form-control auto_num" id="biaya_freight" required name="biaya_freight" value="<?= $head->freight_kurs ?>">
									</div>
								</div>
							</div>
						</div>
			...
			swal({
				...
				function(isConfirm) {
					if (isConfirm) {
						...
						var baseurl = siteurl + 'incoming/SaveLogistik';
						$.ajax({
							url: baseurl,
							type: "POST",
							data: formData,
