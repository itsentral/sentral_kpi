...
?>
 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		echo"</select></th>
		<th id='bentuk_".$loop."'><input readonly value='".$bentuk."' type='text' class='form-control' id='dt_bentuk_$loop' required name='dt[$loop][bentuk]' ></th>
		<th id='idbentuk_".$loop."' hidden><input value='".$id_bentuk."' readonly type='text' class='form-control' id='dt_idbentuk_$loop' required name='dt[$loop][idbentuk]' ></th>
		<th><input type='number' class='form-control' id='dt_weight_$loop' 			required name='dt[$loop][weight]' ></th>
