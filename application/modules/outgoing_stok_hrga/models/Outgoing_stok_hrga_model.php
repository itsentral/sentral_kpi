...
class Outgoing_stok_hrga_model extends BF_Model
{
  ...
  public function __construct()
  {
    ...
    $this->ENABLE_ADD     = has_permission('Outgoing_Stok_HRGA.Add');
    $this->ENABLE_MANAGE  = has_permission('Outgoing_Stok_HRGA.Manage');
    $this->ENABLE_VIEW    = has_permission('Outgoing_Stok_HRGA.View');
    $this->ENABLE_DELETE  = has_permission('Outgoing_Stok_HRGA.Delete');
  }
  ...
  public function server_side_request_produksi()
  {
    ...
    $urut1  = 1;
    $urut2  = 0;
    $GET_STOCK = getStokBarang(19); //17 kode warehouse
  ...
  public function query_data_request_produksi($like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
  {
    ...
    $sql = "SELECT 
            ...
            FROM
              ...
              (SELECT @row:=0) r
            WHERE b.deleted_date IS NULL AND z.outgoing = 'sparepart'
            AND(
  ...
  public function get_query_json_request_material($like_value = NULL, $column_order = NULL, $column_dir = NULL, $limit_start = NULL, $limit_length = NULL)
  {
    ...
    $sql = "SELECT
            ...
            FROM
              ...
              (SELECT @row:=0) r
            WHERE a.deleted_date IS NULL AND a.category='outgoing stok hrga' AND (
