...
{
  //Permission
  protected $viewPermission   = 'Outgoing_Stok_HRGA.View';
  protected $addPermission    = 'Outgoing_Stok_HRGA.Add';
  protected $managePermission = 'Outgoing_Stok_HRGA.Manage';
  protected $deletePermission = 'Outgoing_Stok_HRGA.Delete';
  ...
  public function __construct()
  {
    ...
    $this->load->model(array(
      'Outgoing_stok_hrga/outgoing_stok_hrga_model'
    ));
  ...
  public function index()
  {
    ...
    history("View data outgoing Sparepart Maintenance");
    $this->template->title('Gudang Stok / Outgoing Sparepart Maintenance');
    $this->template->render('index');
  }

  public function data_side_request_material()
  {
    $this->outgoing_stok_hrga_model->data_side_request_material();
  }
  ...
  public function request($id = null)
  {
    if ($this->input->post()) {
      ...
      if (!empty($ArrInsertDetail)) {
        ...
        foreach ($get_warehouse_detail as $item_detail) {
          ...
          $insert_costbook = $this->db->insert('tr_cost_book', [
            ...
            'nm_gudang_dari' => 'GUDANG SPAREPART MAINTENANCE',
          ...
          $insert_costbook1 = $this->db->insert('tr_cost_book', [
            ...
            'tgl' => date('Y-m-d'),
            'no_transaksi' => $kode_trans,
            'jenis_transaksi' => 'In dari Gd. Sparepart Maintenance',
            'qty_transaksi' => $item_detail->qty_oke,
      ...
      $listGudang     = $this->db->get_where('warehouse', array('desc' => 'stok', 'id' => '19'))->result_array();
      ...
      $this->template->title('Outgoing Sparepart Maintenance');
  ...
  {
    $this->outgoing_stok_hrga_model->server_side_request_produksi();
  }
  ...
  {
    $this->outgoing_stok_hrga_model->data_side_spk_material();
  }
