...
<div class="box">
	<div class="box-header">
		<?php if ($ENABLE_ADD) : ?>
			<a class="btn btn-success" href="<?= base_url('master_customer/add_customer') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>New</a>
...
<script type="text/javascript">
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'Master_customer/viewCustomer/'+id,
			data:{'id':id},
	...
	$(document).on('click', '.delete', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'Master_customer/deleteCustomer',
			  dataType : "json",
			  data:{'id':id},
