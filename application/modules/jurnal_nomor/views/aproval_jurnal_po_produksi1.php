...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			if ($record->sts_apr == 1){
			?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View Jurnal Permintaan Bayar" data-id_material="<?=$record->no_po?>" data-id_total="<?=$record->nilai_po_bef_ppn + $record->nilai_ppn?>" data-id_vendor="<?=$vendor->id_vendor?>" data-nm_vendor="<?=$vendor->nama?>"><i class="fa fa-eye"></i>
				</a>
			<?php 
			}
			if ($record->sts_buk == 1){
			?>
				<a class="btn btn-warning btn-sm view2" href="javascript:void(0)" title="View Jurnal Pembayaran" data-id_material="<?=$record->no_po?>" data-id_total="<?=$record->nilai_po_bef_ppn + $record->nilai_ppn?>" data-id_vendor="<?=$vendor->id_vendor?>" data-nm_vendor="<?=$vendor->nama?>"><i class="fa fa-eye"></i>
				</a>
			<?php 
			}
			endif; 
			...
			<td><?= number_format($record->nilai_po_bef_ppn)?></td>
