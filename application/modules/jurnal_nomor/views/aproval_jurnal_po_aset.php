...
<div class="box">
	...
	<div class="box-body">
		...
		<?php if(empty($results)){
			...
			$tglpr  = $this->db->query("SELECT * FROM tr_pr_aset WHERE no_pr='$record->no_pr'")->row();
			$tglpo  = $this->db->query("SELECT * FROM tr_po_aset WHERE no_po='$record->no_po'")->row();
...
<script type="text/javascript">
  ...
  $(document).on('click', '.view', function(){
		...
		var pp = 'poaset';
		var akses = 'approval_jurnal_po_aset';
		// alert(id);
