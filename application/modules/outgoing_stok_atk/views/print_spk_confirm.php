...
<table class="gridtable2" width="100%" border='0'>
    <thead>
        <tr>
            ...
            <td class="mid" width='2%'>:</td>
            <td class="mid" width='30%'>GUDANG PRODUKSI</td>
        </tr>
        <tr>
...
$mpdf->WriteHTML($html);
$mpdf->Output('pengeluaran-material-gudang-produksi.pdf' ,'I');