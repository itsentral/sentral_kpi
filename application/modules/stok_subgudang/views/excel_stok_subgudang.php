...
header("Content-Disposition: attachment; filename=Stock Material Sub Gudang " . strtoupper($results['nm_gudang']) . " - " . date('d F Y', strtotime($results['tanggal'])) . ".xls");
?>
<div style="width: 100%; text-align: center;">
    <h2>Stock Subgudang <?= $results['nm_gudang'] ?> - <?= date('d F Y', strtotime($results['tanggal'])) ?></h2>
</div>
