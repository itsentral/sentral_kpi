...
<script type="text/javascript">
  $(function() {
    ...
    DataTables(date_filter, id_gudang);
  ...
  $(document).on('change', '#date_filter, #id_gudang', function(e) {
    e.preventDefault();
    var date_filter = $('#date_filter').val();
    var id_gudang = $('#id_gudang').val();
    DataTables(date_filter, id_gudang);
  ...
  $(document).on('click', '.download_excel', function() {
    ...
    window.open(siteurl + active_controller + 'download_excel/' + tanggal + '/' + id_gudang, '_blank');
  });

  function DataTables(date_filter = null, id_gudang = null) {
