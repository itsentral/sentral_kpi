...
if (!empty($this->uri->segment(3))) {
  ...
  $name_category    = $this->db->get_where('child_supplier_category', array('id_supplier' => $getC->id_category_supplier))->row();
  $name_sales       = $this->db->get_where('ms_karyawan', array('id_karyawan' => $getC->id_karyawan))->row();
  $name_reference   = $this->db->get_where('child_suppkl_reference', array('id_reference' => $getC->id_reference))->row();
}
...
<section class="content">
  <legend class="legend" style="font-size:26px"><strong><?= strtoupper($getC->name_supplier) ?></strong></legend>
  <div class="row">
    <div class="col-md-6">
      <table width="100%" class="table-condensed">
        <tbody>
          <tr>
            <td width="30%"><strong>ID Supplier</strong></td>
            <td>: <?= strtoupper($getC->id_supplier) ?></td>
          </tr>
          <tr>
  ...
  <!-- <span for="input-id">ID Supplier</span>
  <div class="row">
    <div class="col-md-4">
      <div>
        <div class="">
          <label for="input-id" class="f-16"><?= strtoupper($getC->id_supplier) ?></label>
        </div>
      </div>
    </div>
  </div> -->
        ...
        <div class="row" style="padding-left:10px">
          <div class="col-md-4">
            <div class="mt-2">
              ...
              <div class="">
                <label for="input-id" class="f-16"><?= $name_category->name_category_supplier ?></label>
              </div>
            </div>

            <div class="mt-2">
              <span>Supplier Start Date</span>
              <div class="">
