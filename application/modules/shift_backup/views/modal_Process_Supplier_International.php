...
if (!empty($this->uri->segment(3))) {
  ...
  $name_category    = $this->db->get_where('child_supplier_category', array('id_category_supplier' => $getC->id_category_supplier))->row();
    ...
    <div class="box-body" style="">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-6">
            <section id="DETAIL_SUPPLIER_IDENTITY">
              <table id="my-grid3" class="table-condensed" width="100%">
                <tbody>
                  <tr id="my-grid-tr-id_supplier">
                    ...
                    <td class="text-left">
                      <label class="label_input">
                        ...
                        <input type="text" class="form-control input input-sm required w30 " name="id_supplier" id="id_supplier" value="<?= empty($getC->id_supplier) ? '' : $getC->id_supplier ?>" readonly>
                        <label class="label label-danger id_supplier hideIt">Code Can't be empty!</label>
                      </label>
                    </td>
                  </tr>

                  <tr id="my-grid-tr-name_supplier">
                    <td class="text-left vMid">Supplier Name <span class='text-red'>*</span></b></td>
                    <td class="text-left">
                      <label class="label_input">
                        <?php
                        echo form_input(array('type' => 'text', 'id' => 'name_supplier', 'name' => 'name_supplier', 'class' => 'form-control w80 required', 'placeholder' => 'Supplier Name', 'autocomplete' => 'off', 'value' => empty($getC->name_supplier) ? '' : $getC->name_supplier))
                        ?>
                        <!--<a id="generate_id" class="btn btn-sm btn-primary" style="display:inline-block">Generate ID</a>-->
                        <label class="label label-danger name_supplier hideIt">Supplier Name Can't be empty!</label>
                      </label>
                    </td>
                  </tr>
              ...
              <tbody>
                ...
                <tr id="my-grid-tr-id_prov">
                  ...
                  <td class="text-left">
                    <label class="label_input">
                                              <?php
                        echo form_input(array('type' => 'text', 'id' => 'id_prov', 'name' => 'id_prov', 'class' => 'form-control w80 required', 'placeholder' => 'Province', 'autocomplete' => 'off', 'value' => empty($getC->name_supplier) ? '' : $getC->name_supplier))
                        ?>
                ...
                <tr id="my-grid-tr-city">
                  ...
                  <td class="text-left">
                    ...
                    <label class="label_input">
                                              <?php
                        echo form_input(array('type' => 'text', 'id' => 'city', 'name' => 'city', 'class' => 'form-control w80 required', 'placeholder' => 'City', 'autocomplete' => 'off', 'value' => empty($getC->name_supplier) ? '' : $getC->name_supplier))
                        ?>
            ...
            <section id="DETAIL_PRODUCTIVITY">
              <table id="my-grid2" class="table-condensed" width="100%">
                <tbody>
                  ...
                  <tr id="my-grid-tr-id_category_supplier">
                    <td class="text-left vMid" width="30%">Category <span class='text-red'>*</span></b></td>
                    <td class="text-left">
                      <label class="label_view">
                        <?= $name_category->name_category_Supplier ?>
                      </label>
                      <label class="label_input">
                        <select class="form-control required select2 w50" name="id_category_supplier" id="id_category_supplier">
                        </select>
                        <label class="label label-danger id_category_supplier hideIt">Category Can't be empty!</label>
                      </label>
                    </td>
                  </tr>

                  <tr id="my-grid-tr-start_date">
                    <td class="text-left vMid">Supplier Start Date <span class='text-red'>*</span></b></td>
                    <td class="text-left">
                      <?php
                      echo form_input(array('type' => 'text', 'id' => 'start_date', 'name' => 'start_date', 'class' => 'form-control required datepicker w30', 'placeholder' => 'Supplier Start Date', 'autocomplete' => 'off', 'value' => empty($getC->start_date) ? date('Y-m-d') : $getC->start_date))
                      ?>
                      <label class="label label-danger start_date hideIt">Supplier Start Date Can't be empty!</label>
                      <label class="label_input">
                      </label>
                    </td>
                  </tr>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('change', '#id_category_supplier', function(e) {
      var id_selected = $('#id_category_supplier').val();
      getCode(id_selected);
  ...
  function getSupplierCat() {
    if ('<?= ($getC->id_category_supplier) ?>' != null) {
      var id_selected = '<?= $getC->id_category_supplier ?>';
    } else if ($('#id_category_supplier').val() != null || $('#id_category_supplier').val() != '') {
      var id_selected = $('#id_category_supplier').val();
    } else {
      var id_selected = '';
    }
    ...
    var column = '';
    var column_fill = '';
    var column_name = 'name_category_supplier';
    var table_name = 'child_supplier_category';
    var key = 'id_category_supplier';
    var act = '';
    $.ajax({
      url: siteurl + active_controller + "getOpt",
      dataType: "json",
      ...
      success: function(result) {
        $('#id_category_supplier').html(result.html);
      },
      error: function(request, error) {
        console.log(arguments);
        alert(" Can't do because: " + error);
