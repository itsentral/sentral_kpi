...
<div class="box box-primary">
	<div class="box-body">
		<form id="data_form" method="post"  autocomplete="off" enctype='multiple/form-data'>
			...
			<div class="form-group row">
				<div class="col-md-2">
					<label>Mold Price /Hour</label>
				</div>
				<div class="col-md-4">
					<input type="text" class="form-control maskM" id="biaya_mesin" name="biaya_mesin" value='<?=$biaya_mesin;?>' placeholder="Mold Price /Hour" readonly>
				</div>
				<div class="col-md-2">
					<label>Utilisasi /Pcs</label>
				</div>
				<div class="col-md-4">
					<input type="text" class="form-control maskM getDep" id="used_hour_month" name="used_hour_month" value='<?=$used_hour_month;?>' placeholder="Utilisasi /Pcs">
				</div>
			</div>
