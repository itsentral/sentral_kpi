...
<body>
    ...
    <table class="gridtable2" border="0">
        <tr>
            ...
            <td align="right" width="350" valign="top">
                <b style="text-decoration: underline; font-size: 20px;">JAMINAN</b>
            </td>
        </tr>
    </table>
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td align="left" width="150" style="border: 1px solid black;"><span style="font-weight: bold;">Total Jaminan</span></td>
