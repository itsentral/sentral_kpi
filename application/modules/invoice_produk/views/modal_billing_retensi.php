...
foreach ($results['list_spk_delivery'] as $item_spk) {
    ...
    $get_spk_delivery_detail = $this->db
        ...
        ->join('tr_sales_order_detail b', 'b.id_so_detail = a.id_so_det', 'left')
    ...
    $nilai_ppn = ($dpp * $results['data_so']->ppn / 100);
    $retensi_prorportion = (($dpp + $nilai_ppn) * $persen_retensi / 100);
...
<input type="hidden" class="persen_retensi" name="persen_retensi" value="<?= $persen_retensi ?>">
