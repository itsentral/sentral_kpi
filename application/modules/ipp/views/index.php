<?php
    $ENABLE_ADD     = has_permission('IPP.Add');
    $ENABLE_MANAGE  = has_permission('IPP.Manage');
    $ENABLE_VIEW    = has_permission('IPP.View');
    $ENABLE_DELETE  = has_permission('IPP.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<div class="box">
    ...
    <span class="pull-right">
			<?php if($ENABLE_ADD) : ?>
					<a class="btn btn-success btn-sm" href="<?= base_url('ipp/add') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
