			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					<select id="id_customer" name="id_customer" class="form-control input-md chosen-select">
						...
						?>
							<option value="<?= $value['id_customer']; ?>" <?= $sel; ?>><?= strtoupper($value['name_customer']) ?></option>
						<?php } ?>
					</select>
				</div>
			</div>
				...
				<div class="col-md-4">
					<select id="delivery_category" name="delivery_category" class="form-control input-md chosen-select">
						...
						<?php foreach ($deliv_category as $val => $value) {
							$sel = ($value['id'] == $delivery_category) ? 'selected' : '';
						?>
				...
				<div class="col-md-4">
					<select id="shipping_method" name="shipping_method" class="form-control input-md chosen-select">
						...
						<?php foreach ($shipping as $val => $value) {
							$sel = ($value['id'] == $shipping_method) ? 'selected' : '';
						?>
							<option value="<?= $value['id']; ?>" <?= $sel; ?>><?= strtoupper($value['name']) ?></option>
						<?php } ?>
					</select>
			...
			<div>
				...
				if (!empty($detail)) {
					foreach ($detail as $val => $valx) {
						...
						echo "	</div>";
						echo "	<div class='col-md-4'>";
						echo "	<select name='Detail[" . $val . "][id_bom_topping]' class='form-control chosen-select'>";
						echo "		<option value='0'>Select BOM Topping</option>";
						foreach ($list_bom_topping as $valy => $valxy) {
							$nama_level = (!empty($valxy['nama_lv4'])) ? $valxy['nama_lv4'] : $valxy['nama_lv3'];
							$selected = ($id_bom_topping == $valxy['no_bom']) ? 'selected' : '';
							echo "<option value='" . $valxy['no_bom'] . "' " . $selected . ">" . strtoupper($nama_level . ' - ' . $valxy['variant_product']) . "</option>";
						}
						echo 	"</select>";
						echo "	</div>";
						echo "</div>";
						...
						echo "	<table class='table table-striped table-bordered table-hover table-condensed'>";
						echo "		<tr class='bg-blue'>";
						echo "			<th class='text-center'>Accessories</th>";
						echo "			<th class='text-center' width='15%'>Qty Order</th>";
						echo "			<th class='text-center' width='10%'>#</th>";
						echo "		</tr>";

						$getdetailProduct4 = $this->db->get_where('ipp_detail_lainnya', array('category' => 'accessories', 'no_ipp' => $valx['no_ipp'], 'no_ipp_code' => $valx['no_ipp_code']))->result_array();
						$new_number = 0;
						foreach ($getdetailProduct4 as $key => $value) {
							$new_number++;
							$where = array('deleted_date' => NULL, 'id_category' => '5');
							$product4Detail    = $this->db->get_where('accessories', $where)->result();

							echo "<tr id='headeracc_" . $val . "_" . $new_number . "'>";
							echo "<td align='left'>";
							echo "<select name='Detail[" . $val . "][accessories][" . $new_number . "][code_lv4]' class='chosen-select form-control input-sm'>";
							echo "<option value='0'>Select Accessories</option>";
							foreach ($product4Detail as $productlv4) {
								$selected = ($value['code_lv4'] == $productlv4->id) ? 'selected' : '';
								echo "<option value='" . $productlv4->id . "' " . $selected . ">" . strtoupper($productlv4->stock_name) . "</option>";
							}
							echo "</select>";
							echo "</td>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][accessories][" . $new_number . "][order]' class='form-control input-md text-center autoNumeric0 qty' placeholder='Order' value='" . $value['order'] . "'>";
							echo "</td>";
							echo "<td align='center'>";
							echo "&nbsp;<button type='button' class='btn btn-sm btn-danger delPartAcc' title='Delete'><i class='fa fa-close'></i></button>";
							echo "</td>";
							echo "</tr>";
						}


						echo "		<tr id='addacc_" . $val . "_" . $new_number . "'>";
						echo "			<td><button type='button' class='btn btn-sm btn-warning addPartAcc' title='Add Accessories'><i class='fa fa-plus'></i>&nbsp;&nbsp;Add Accessories</button></td>";
						echo "			<td></td>";
						echo "			<td></td>";
						echo "		</tr>";
						echo "	</table>";
						...
						echo "<div class='form-group row'>";
						echo "	<div class='col-md-2'>";
						echo "		<label>Tambahan Flat Sheet</label>";
						echo "	</div>";
						echo "	<div class='col-md-5'>";
						echo "	<table class='table table-striped table-bordered table-hover table-condensed'>";
						echo "		<tr class='bg-blue'>";
						...
						$getdetailProduct4 = $this->db->get_where('ipp_detail_lainnya', array('category' => 'flat sheet', 'no_ipp' => $valx['no_ipp'], 'no_ipp_code' => $valx['no_ipp_code']))->result_array();
						$new_number = 0;
						foreach ($getdetailProduct4 as $key => $value) {
							$new_number++;

							echo "<tr id='headersheet_" . $val . "_" . $new_number . "'>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][flat_sheet][" . $new_number . "][length]' class='form-control input-md text-center autoNumeric4' value='" . $value['length'] . "'>";
							echo "</td>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][flat_sheet][" . $new_number . "][width]' class='form-control input-md text-center autoNumeric4' value='" . $value['width'] . "'>";
							echo "</td>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][flat_sheet][" . $new_number . "][order]' class='form-control input-md text-center autoNumeric0' value='" . $value['order'] . "'>";
							echo "</td>";
							echo "<td align='center'>";
							echo "&nbsp;<button type='button' class='btn btn-sm btn-danger delPartSheet' title='Delete'><i class='fa fa-close'></i></button>";
							echo "</td>";
							echo "</tr>";
						}
						echo "		<tr id='addsheet_" . $val . "_" . $new_number . "'>";
						echo "			<td><button type='button' class='btn btn-sm btn-warning addPartSheet' title='Add Flat Sheet'><i class='fa fa-plus'></i>&nbsp;&nbsp;Add Flat Sheet</button></td>";
						echo "			<td></td>";
						echo "			<td></td>";
						echo "		</tr>";
						echo "	</table>";
						...
						echo "<div class='form-group row'>";
						echo "	<div class='col-md-2'>";
						echo "		<label>Sesuai Gambar</label>";
						echo "	</div>";
						...
						echo "<div class='form-group row'>";
						echo "	<div class='col-md-2'>";
						echo "		<label>End Plate /Kick Plate</label>";
						echo "	</div>";
						echo "	<div class='col-md-5'>";
						echo "	<table class='table table-striped table-bordered table-hover table-condensed'>";
						echo "		<tr class='bg-blue'>";
						echo "			<th class='text-center' width='30%'>Length</th>";
						echo "			<th class='text-center' width='30%'>Thickness</th>";
						echo "			<th class='text-center' width='30%'>Qty</th>";
						echo "			<th class='text-center' width='10%'>#</th>";
						echo "		</tr>";

						$getdetailProduct4 = $this->db->get_where('ipp_detail_lainnya', array('category' => 'end plate', 'no_ipp' => $valx['no_ipp'], 'no_ipp_code' => $valx['no_ipp_code']))->result_array();
						$new_number = 0;
						foreach ($getdetailProduct4 as $key => $value) {
							$new_number++;

							echo "<tr id='headerend_" . $val . "_" . $new_number . "'>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][end_plate][" . $new_number . "][length]' class='form-control input-md text-center autoNumeric4' value='" . $value['length'] . "'>";
							echo "</td>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][end_plate][" . $new_number . "][width]' class='form-control input-md text-center autoNumeric4' value='" . $value['width'] . "'>";
							echo "</td>";
							echo "<td align='left'>";
							echo "<input type='text' name='Detail[" . $val . "][end_plate][" . $new_number . "][order]' class='form-control input-md text-center autoNumeric0' value='" . $value['order'] . "'>";
							echo "</td>";
							echo "<td align='center'>";
							echo "&nbsp;<button type='button' class='btn btn-sm btn-danger delPartEnd' title='Delete'><i class='fa fa-close'></i></button>";
							echo "</td>";
							echo "</tr>";
						}
						echo "		<tr id='addend_" . $val . "_" . $new_number . "'>";
						echo "			<td><button type='button' class='btn btn-sm btn-warning addPartEnd' title='Add End/Kick Plate'><i class='fa fa-plus'></i>&nbsp;&nbsp;Add End/Kick Plate</button></td>";
						echo "			<td></td>";
						echo "			<td></td>";
						echo "		</tr>";
						echo "	</table>";
