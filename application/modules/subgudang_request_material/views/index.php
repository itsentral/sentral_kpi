<?php
    $ENABLE_ADD     = has_permission('Request_Material_Subgudang.Add');
    $ENABLE_MANAGE  = has_permission('Request_Material_Subgudang.Manage');
    $ENABLE_VIEW    = has_permission('Request_Material_Subgudang.View');
    $ENABLE_DELETE  = has_permission('Request_Material_Subgudang.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<div class="box">
	<div class="box-header">
		<?php if($ENABLE_ADD){ ?>
		<a class="btn btn-primary btn-sm" style='float:right;' href="<?= base_url('subgudang_request_material/request') ?>" title="Request">Add Request</a>
		<?php } ?>
    	<!-- <br> -->
