				...
				<td>
					...
					<select name='id_costcenter' id='id_costcenter' class='form-control input-sm chosen-select'>
						...
						foreach ($listCostcenter as $key => $value) {
							$selected = ($value['id'] == $getData[0]['id_gudang_ke'])?'selected':'';
	...
	<table class="table table-striped table-bordered table-hover table-condensed" width="100%">
		<thead>
			<tr>
                ...
                <th class='text-center' width='6%'>Packing</th>
                <th class='text-center' width='8%'>Req. (Pack)</th>
                <th class='text-center' width='6%'>Konversi</th>
                <th class='text-center' width='8%'>Total (Unit)</th>
                <th class='text-center' width='6%'>Unit</th>
                <th class='text-center' width='9%'>Keterangan</th> 
				<?php
				if($tanda != 'edit'){
					?>
						<th class='text-center' width='8%'>Confirm (Pack)</th>
                		<th class='text-center' width='9%'>Keterangan</th>
					<?php
				}
				?>
