...
<div class="box">
	...
	<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('inventory_5/addInventory/I2000001') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
			    <a class="btn btn-success btn-sm" href="<?= base_url('inventory_5/editInventory/'.$record->id_material.'/'.$record->id_type) ?>" title="Edit"> <i class="fa fa-edit">&nbsp;</i></a>
