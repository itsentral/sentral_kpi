...
<div class="box">
    	<div class="nav-tabs-custom">
				...
				<li class="dropdown">
					<a class="btn btn-primary" data-toggle="dropdown" href="#">TAMBAH DATA
					<span class="caret"></span></a>
					<ul class="dropdown-menu">
					<?php foreach ($result['inventory_1'] as $menu1){ 
						?>
						<li><a href="<?= base_url('inventory_5/addInventory/') ?><?= $menu1->id_type ?>"><?= $menu1->nama ?></a></li>
					<?php } ?>
	...
	<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
					<!--<a class="btn btn-success btn-sm" href="<?= base_url('inventory_5/addInventory') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			-->
			<?php endif; ?>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
				<a class="btn btn-primary btn-sm view" href="javascript:void(0)" title="View" data-id_material="<?=$record->id_material?>"><i class="fa fa-eye"></i>
				</a>
			<?php endif; ?>
...
<script type="text/javascript">
	...
	$(document).on('click', '.view', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'inventory_5/viewNonmaterial/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
