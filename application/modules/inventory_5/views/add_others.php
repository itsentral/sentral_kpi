		...
		<div id="input1">
			<div class="col-md-12">			    
				...
				<div class="form-group row">
					...
					<div class="col-md-8">
					<?php foreach ($results['type_1'] as $tipe){ 
						?>
					  <input type="hidden" class="form-control input-sm" id="inventory_1"  name="inventory_1" placeholder="Id Inventory" value="<?= $tipe->id_type?>" required>
	                  <input type="text" class="form-control input-sm" id="nama_inv"  name="nama_inv" placeholder="Nama Inventory" value="<?= $tipe->nama ?>" required readonly>
					<?php } ?>				
					</div>
				</div>
				</div>
				...
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <input type="hidden" class="form-control input-sm" id="spec4"  name="spec4" placeholder="Spesifikasi 4" value="" required>
					</div>
				</div>
				</div>
			    <div class="col-md-5">
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <input type="hidden" class="form-control input-sm" id="spec5"  name="spec5" placeholder="Spesifikasi 5" value="" required>
					</div>
				</div>
				</div>  
				<div class="col-md-5">
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <input type="hidden" class="form-control input-sm" id="spec6"  name="spec6" placeholder="Spesifikasi 6" value="" required>
					</div>
				</div>
				</div>  
				<div class="col-md-5">
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <input type="hidden" class="form-control input-sm" id="spec7"  name="spec7" placeholder="Spesifikasi 7" value="" required>
					</div>
				</div>
				</div>  
				<div class="col-md-5">
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <input type="hidden" class="form-control input-sm" id="spec8"  name="spec8" placeholder="Spesifikasi 8" value="" required>
					</div>
				</div>
				</div>  
				<div class="col-md-5">
				<div class="form-group row">
					<div class="col-md-4">
					 ...
					 <div class="col-md-8">
					  <input type="hidden" class="form-control input-sm" id="spec9"  name="spec9" placeholder="Spesifikasi 9" value="" required>
					</div>
				</div>
				</div> -->
				<div class="col-md-5">
						...
						$.ajax({
							...
							success		: function(data){								
								if(data.status == 1){											
									...
									window.location.href = base_url + active_controller+'list_nonmaterial/'+idtype;
								}else{
