<?php
$inv          =  $this->db->query("SELECT * FROM tr_invoice_np_header WHERE no_invoice = '$no_inv' ")->row();
$alamat_cust =  $this->db->query("SELECT * FROM master_customers WHERE id_customer = '$inv->id_customer'")->row();
?>
                          ...
                          <div hidden class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <?php
									...
									echo form_dropdown('jenis_pph',$pphpenjualan, (isset($data)?$data->jenis_pph:'1102-01-03'), array('id'=>'jenis_pph','class'=>'form-control'));
								  ?>
                              </div>
                          </div>
                        </div>
		...
		<div class="row">
			...
			<div class="col-lg-6">
					    <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="total_invoice" class="form-control input-sm divide" id="total_invoice" value="<?=number_format($inv->sisa_invoice_idr)?>" readonly tabindex="-1" onchange="cekall()">
                            </div>
                        </div>
                        <!--<div class="form-group ">
					    ...
					    <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                              <input type="text" name="selisih" class="form-control input-sm divide" id="selisih" value="<?=number_format($inv->selisih)?>" readonly tabindex="-1">
                            </div>
                        </div>
                       <div class="form-group ">
              ...
              <tbody>
                  ...
                  ?>
						  <tr>
							  ...
							  <td><center><?php echo number_format($vs->grand_total) ?></center></td>
	 ...
	 function savemutasi(){
        ...
        function(isConfirm){
			if(isConfirm) {
				...
				$.ajax({
					url: siteurl+"penerimaan/save_penerimaan_np",
					dataType : "json",
					type: 'POST',
					data: formdata,
					success: function(data){
						...
						window.location.href = base_url + active_controller+'jurnal_bum_np/';
					  }else{
...
//		totalterima();
    ...
    $(document).on('click', '.add', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'penerimaan/TambahInvoice_np/'+id_customer,
