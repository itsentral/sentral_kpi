                                    ...
                                    <div class="col-md-12">
                                        <div class='col-sm-6'>
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-md-8'>
                                                    <input type="text" name="term_of_payment" id="" class="form-control" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->top : null ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-sm-6'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group " style="padding-top:15px;">
                                    <label class="col-sm-4 control-label">% Discount</label>
                                    <div class="col-sm-6">
                                        <input type="text" name="ttl_persen_discount" class="form-control input-sm text-right ttl_persen_discount" id="" value="<?= number_format(($total_price_before_discount - $total_all) / $total_price_before_discount * 100, 2) ?>%" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6"></div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group " style="padding-top:15px;">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="persen_ppn" class="form-control input-sm text-right persen_ppn" id="" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->ppn . '%' : null ?>" readonly>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" name="nilai_ppn" class="form-control input-sm text-right nilai_ppn" id="total" value="<?= (isset($results['data_penawaran'])) ? ($results['data_penawaran']->nilai_ppn) : null ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6"></div>
