            ...
            <div class="col-4">
                <div class="text-right">
                    <div class="form-group ">
                        <label for="">Reject Reason</label> <br>
                        <textarea name="reject_reason" id="" cols="100" rows="10" class="reject_reason"></textarea>
                    </div>
                </div>
            </div>
            <!-- </div> -->
