        ...
        <form id="data-form" method="post">
            ...
            <table id="example1" class="table table-sm table-bordered">
                ...
                <tbody>
                    ...
                    echo '<tr>';
                    echo "<td style='background-color:#cbcbcb;' class='text-center'>#</td>";
                    echo "<td style='background-color:#cbcbcb;' class='text-left text-bold' colspan='2'>Accessories</td>";
                    echo "<td style='background-color:#cbcbcb;' class='text-right'>" . number_format($ttl_accessories, 2) . "</td>";
                    echo "<td style='background-color:#cbcbcb;' colspan='2'><span id='DetailAccessories'>Show/Hide</span></td>";
                    echo '</tr>';

                    $no_access = 1;
                    foreach ($detail_accessories as $item) {
                        $get_accessories_detail = $this->db->get_where('accessories', ['id' => $item['code_material']])->row();

                        echo "<tr class='DetailAccessories'>";
                        echo "<td class='text-center'>" . $no_access . "</td>";
                        echo "<td class='text-left' colspan='2'>" . $get_accessories_detail->stock_name   . "</td>";
                        echo "<td class='text-right'>" . number_format($get_accessories_detail->price_ref_use_usd * $item['weight'], 2) . "</td>";
                    ...
                    foreach ($dataList as $key => $value) {
                        if ($value['judul'] == 'Lainnya') {
                            ...
                            if ($value['code'] == '19') {
                                $rate         = '';
                                $cost        = $product_price[0]['cost_price_final'] + $ttl_accessories;
                            }
                            echo "<tr>";
                            ...
                            <td colspan='4'>
                                <table class='table table-bordered'>
                                    ...
                                    foreach ($detail_ipp_ukuranjadi as $key => $value) {
                                        ...
                                        echo "<td class='text-center'>" . number_format($value['order']) . "</td>";
                                        echo "<td>
                                            <input type='hidden' name='ukuran_jadi_price[$key][id]' class='form-control input-sm' value='" . $value['id'] . "'>
                                            <input type='hidden' name='ukuran_jadi_price[$key][qty]'  id='qty_" . $key . "' class='form-control input-sm' value='" . $value['order'] . "'>
                                            <input type='hidden' name='ukuran_jadi_price[$key][width]' class='form-control input-sm' value='" . $value['width'] . "'>
                                            <input type='hidden' name='ukuran_jadi_price[$key][length]' class='form-control input-sm' value='" . $value['length'] . "'>
                                            <input type='text' name='ukuran_jadi_price[$key][price_unit]' id='price_unit_" . $key . "' data-id='" . $key . "' class='form-control input-sm autoNumeric2 text-right changePrice'>
                                            </td>";
                                        echo "<td>
                                            <input type='text' name='ukuran_jadi_price[$key][total_price]' id='total_price_" . $key . "' class='form-control input-sm text-right autoNumeric2' readonly>
                                            </td>";
                                        echo "</tr>";
                                    }
                                    echo "<tr>";
                                    ...
                                    echo "<td><input type='text' name='total_price_uj' id='total_price' class='form-control input-sm text-right autoNumeric2'  style='vertical-align:middle;' readonly></td>";
                                    echo "</tr>";
                                    echo "<tr>";
                                    echo "<td colspan='3'></td>";
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.addJoint, .addFlatSheet, .addEndPlate, .addChequeredPlate, .addOthers, .CuttingProcess, .DetailAccessories').hide();
        ...
        $(document).on('click', '#DetailAccessories', function() {
            $('.DetailAccessories').toggle();
        });
