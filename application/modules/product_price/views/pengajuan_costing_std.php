...
<div class="box box-primary">
	<div class="box-body">
        <form id="data-form" method="post">
            ...
            <input type="text" id='no_bom' name='no_bom' value="<?=$no_bom;?>">
            <input type="text" id='kode' name='kode' value="<?=$product_price[0]['kode'];?>">
            <table id="example1" class="table table-sm table-bordered">
                ...
                <tbody>
                    ...
                    echo "<tr>";
                        ...
                        echo "<td class='text-center'>((".number_format($product_price[0]['ct_setting'],2)." + ".number_format($product_price[0]['ct_produksi'],2).") * ".number_format($product_price[0]['qty_man_power'],2)." / 60) * ".number_format($product_price[0]['rate_man_power_usd'],2)."</td>";
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.detailRate', function(){
            ...
            $.ajax({
                ...
                data:{'id_product':id_product,'tanda':tanda,'cost':cost,'no_bom':no_bom},
                success:function(data){
                    $("#dialog-popup").modal();
                    $("#ModalView").html(data);
