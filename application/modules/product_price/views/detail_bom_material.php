...
<div class="box box-primary">
	<div class="box-body">
		...
		<table class='' width='100%'>
			...
			<tbody>
				<?php
					foreach($detail_assembly AS $val => $valx){ $val++;
			...
			<thead>
				<tr>
					<th colspan='8'>Material Joint</th>
				</tr>
				<tr>
					<th class='text-left' style='width: 3%;'>#</th>
					<th class='text-left'>Material Type</th>
			...
			<?php } ?>
				...
				if($header[0]->category == 'standard'){
					...
					<tr>
						...
						<td class='text-right text-bold'><?=number_format($SUM_TOTAL_BERAT,4);?> Kg</td>
						<td class='text-left' colspan='3'></td>
						<td class='text-right text-bold'><?=number_format($TOTAL_PRICE_ALL,2);?></td>
					</tr>
					<tr>
						<td class='text-left' colspan='4'></td>
						<td class='text-left text-bold'>Harga Per Kilo</th>
						<td class='text-left' colspan='4'></td>
						<td class='text-right text-bold'><?=number_format($harga_per_kilo,2);?></td>
					</tr>
					<tr>
						<td class='text-left' colspan='4'></td>
						<td class='text-left'>Waste Product</th>
						<td class='text-right text-blue'><?=number_format($header[0]->waste_product,4);?> Kg</td>
						<td class='text-left' colspan='4'></td>
					</tr>
					<?php
				}
