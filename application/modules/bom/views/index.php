...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<th class='text-right'>Total<br>Weight (Kg)</th>
			<th class='text-right'>Waste<br>Product (Kg)</th>
			<th class='text-right'>Waste<br>Set/Cleaning<br>Resin (Kg)</th>
			<th class='text-right'>Waste<br>Set/Cleaning<br>Glass (Kg)</th>
			<th>Last By</th>
