        ...
        <!-- Biodata Mitra -->
            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_data','name'=>'frm_data','role'=>'form','class'=>'form-horizontal')) ?>
				...
				<div class="col-md-16">
					...
					<div class="form-group ">
						<label for="coa" class="col-sm-2 control-label">Kategori Asset<font size="4" color="red"><B>*</B></font></label>
						<div class="col-sm-6">
							<div class="input-group">
								<?php
					...
					<div class="form-group ">
						<label for="penyusutan" class="col-sm-2 control-label">Kategori Penyusutan<font size="4" color="red"><B>*</B></font></label>
						<div class="col-sm-6">
							<div class="input-group">
								<?php
                    ...
                    <div class="form-group ">
						<label for="budget" class="col-sm-2 control-label">Sisa Budget Terhadap PR<font size="4" color="red"><B>*</B></font></label>
						<div class="col-sm-6">
							<div class="input-group">
							<input type="text" class="form-control divide" id="budgetpr" name="budgetpr" value="<?php echo set_value('budget', isset($data->budget) ? $data->budget: '0'); ?>" placeholder="budget" required>
							</div>
						</div>
					</div>	
                    <div class="form-group ">
						<label for="budget" class="col-sm-2 control-label">Sisa Budget Terhadap PO<font size="4" color="red"><B>*</B></font></label>
						<div class="col-sm-6">
							<div class="input-group">
							<input type="text" class="form-control divide" id="budgetpo" name="budgetpo" value="<?php echo set_value('budget', isset($data->budget) ? $data->budget: '0'); ?>" placeholder="budget" required>
							</div>
						</div>
					</div>
					 <div class="form-group ">
                    ...
                    <div class="form-group ">
						<label for="budget" class="col-sm-2 control-label">Keterangan<font size="4" color="red"><B>*</B></font></label>
						<div class="col-sm-6">
							<div class="input-group">
					...
					<div class="box-footer">
						<div class="form-group">
							...
							<a class="btn btn-warning" data-toggle="modal" onclick="reject()"><i class="fa fa-times-circle">&nbsp;</i>Reject</a>
...
<script type="text/javascript">
	...
	function reject(){
	 var formdata = $("#frm_data").serialize();
        $.ajax({
            url: siteurl+"aset/reject_approve",
            dataType : "json",
            type: 'POST',
            data: formdata,
            success: function(msg){
