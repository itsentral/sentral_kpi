<?php
$ENABLE_ADD     = has_permission('Costbook_Material_Per_Item.Add');
$ENABLE_MANAGE  = has_permission('Costbook_Material_Per_Item.Manage');
$ENABLE_VIEW    = has_permission('Costbook_Material_Per_Item.View');
$ENABLE_DELETE  = has_permission('Costbook_Material_Per_Item.Delete');
