<?php
$ENABLE_ADD     = has_permission('Costbook_Material_Neraca_Gudang.Add');
$ENABLE_MANAGE  = has_permission('Costbook_Material_Neraca_Gudang.Manage');
$ENABLE_VIEW    = has_permission('Costbook_Material_Neraca_Gudang.View');
$ENABLE_DELETE  = has_permission('Costbook_Material_Neraca_Gudang.Delete');
