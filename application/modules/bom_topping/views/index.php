<?php
    $ENABLE_ADD     = has_permission('BOM_Topping.Add');
    $ENABLE_MANAGE  = has_permission('BOM_Topping.Manage');
    $ENABLE_VIEW    = has_permission('BOM_Topping.View');
    $ENABLE_DELETE  = has_permission('BOM_Topping.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<div class="box">
    ...
    <span class="pull-right">
			<?php if($ENABLE_ADD) : ?>
					<a class="btn btn-success btn-md" href="<?= base_url('bom_topping/add') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
      <a class="btn btn-success btn-md" href="<?= base_url('bom_topping/excel_report_all_bom') ?>" target='_blank' title="Download Excel"> <i class="fa fa-file-excel-o">&nbsp;</i>&nbsp;Download Excel</a>
