		...
		<div class="box-body">
			<ul class="nav nav-tabs" role="tablist">
				<li class="nav-item active">
					<a class="nav-link active" id="nonmixing-tab" data-toggle="tab" href="#nonmixing" role="tab" aria-controls="nonmixing" aria-selected="true">Request Mixing</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="request-tab" data-toggle="tab" href="#request" role="tab" aria-controls="request" aria-selected="false">Request Gudang Produksi</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="requestftc-tab" data-toggle="tab" href="#requestftc" role="tab" aria-controls="requestftc" aria-selected="false">Request Gudang Produksi F-Tackle</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="requestcut-tab" data-toggle="tab" href="#requestcut" role="tab" aria-controls="requestcut" aria-selected="false">Request Material Cutting</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="requestass-tab" data-toggle="tab" href="#requestass" role="tab" aria-controls="requestass" aria-selected="false">Request Material Assembly</a>
				</li>
			</ul>
			<div class="tab-content">
				...
				<div class="tab-pane" id="requestftc" role="tabpanel" aria-labelledby="requestftc-tab"><br>
				...
				<div class="tab-pane" id="requestcut" role="tabpanel" aria-labelledby="requestcut-tab"><br>
				...
				<div class="tab-pane" id="requestass" role="tabpanel" aria-labelledby="requestass-tab"><br>
...
<script type="text/javascript">
	...
	$(document).on('click', '.detail2', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: base_url + active_controller + '/modal_request_edit_ftackle/' + kode_trans + '/' + tanda,
			success: function(data) {
				$("#ModalView2").modal();
				$("#view2").html(data);
			},
	...
	$(document).on('click', '.detail3', function(e) {
		...
		$.ajax({
			type: 'POST',
			url: base_url + active_controller + '/modal_request_edit_cutting/' + kode_trans + '/' + tanda,
			success: function(data) {
				$("#ModalView2").modal();
				$("#view2").html(data);
			},
	...
	$(document).on('click', '.detail4', function(e) {
		e.preventDefault();
		...
		$.ajax({
			type: 'POST',
			url: base_url + active_controller + '/modal_request_edit_assembly/' + kode_trans + '/' + tanda,
			success: function(data) {
				$("#ModalView2").modal();
				$("#view2").html(data);
			},
	...
	$(document).on('click', '#edit_materialftc', function() {
		...
		swal({
			...
			function(isConfirm) {
				if (isConfirm) {
					var formData = new FormData($('#form_proses')[0]);
					$.ajax({
						url: base_url + active_controller + '/modal_request_edit_ftackle',
						type: "POST",
						data: formData,
						cache: false,
						dataType: 'json',
	...
	$(document).on('click', '#edit_materialacc', function() {
...
swal({
	...
	function(isConfirm) {
		if (isConfirm) {
			var formData = new FormData($('#form_proses')[0]);
			$.ajax({
				url: base_url + active_controller + '/modal_request_edit_assembly',
				type: "POST",
				data: formData,
				cache: false,
				dataType: 'json',
	...
	function DataTables3() {
		var dataTable = $('#example3').DataTable({
			...
			"ajax": {
				url: siteurl + active_controller + 'data_side_request_material_ftackle',
				type: "post",
				// data: function(d){
				// 	d.sales_order = sales_order
				// },
	...
	function DataTables4() {
		var dataTable = $('#example4').DataTable({
			...
			"ajax": {
				url: siteurl + active_controller + 'data_side_request_material_cutting',
				type: "post",
				// data: function(d){
				// 	d.sales_order = sales_order
				// },
	...
	function DataTables5() {
		var dataTable = $('#example5').DataTable({
			...
			"ajax": {
				url: siteurl + active_controller + 'data_side_request_material_assembly',
				type: "post",
				// data: function(d){
				// 	d.sales_order = sales_order
				// },
