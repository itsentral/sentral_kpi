<div class="box-body">
        ...
        <tbody>
            ...
            if (!empty($getDataDetail)) {
                ...
                foreach ($getDataDetail as $key => $value) {
                    ...
                    $stok_to = (!empty($GET_STOK_TO[$id_material]['stok'])) ? $GET_STOK_TO[$id_material]['stok'] : 0;
                    echo "<tr>";
    ...
    <?php
    if ($tanda == 'edit') {
        echo form_button(array('type' => 'button', 'class' => 'btn btn-sm btn-primary', 'style' => 'min-width:100px; float:right; margin: 5px 0px 5px 0px;', 'value' => 'Save', 'content' => 'Confirm', 'id' => 'edit_materialftc'));
    }
    ?>
</div>
<style>
