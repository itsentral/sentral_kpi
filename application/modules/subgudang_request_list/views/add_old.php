					...
					<table class="table table-bordered table-striped" width='100%'>
						...
						foreach ($getMaterialMixing as $key => $value) {
							...
							echo "<td>
									...
									<input type='hidden' name='detail[" . $key . "][stock]' value='" . $stock . "'>
									<input type='text' name='detail[" . $key . "][berat_aktual]' class='form-control autoNumeric4 text-center' value='" . $berat . "'>
									</td>";
							echo "</tr>";
						}
						?>
