...
<table class="gridtable2" border='1' width='100%' cellpadding='2'>
    ...
    <tr>
        <td align='center'><b><h2>SURAT PENGELUARAN MATERIAL</h2></b></td>
    </tr>
</table>
<br>
<br>
<table class="gridtable2" width="100%" border='0'>
    <thead>
        <tr>
            ...
            <td class="mid" width='2%'>:</td>
            <td class="mid" width='30%'><?=strtoupper(get_name('ms_costcenter','nama_costcenter','id_costcenter',$getData[0]['kd_gudang_ke']));?></td>
        </tr>
        <tr>
            ...
            <td class="mid">:</td>
            <td class="mid"><?=$getData[0]['no_spk'];?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="mid">Nama Product</td>
            <td class="mid">:</td>
            <td class="mid" colspan='4'><?=$getData[0]['nama_product'];?></td>
        </tr>
    </thead>
</table><br>
<table class="gridtable" width='100%' border='1' cellpadding='2'>
    <thead align='center'>
        <tr>
            ...
            <th class="mid" width='11%'>Request</th>
    ...
    <tbody>
        ...
        foreach ($getDataDetail as $key => $value) { $No++;
            ...
            echo "<tr>";
                ...
                echo "<td align='center'>".number_format($berat_act,4)."</td>";
                echo "<td align='center'>".strtoupper($unit)."</td>";
