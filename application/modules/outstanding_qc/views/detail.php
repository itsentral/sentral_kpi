		...
		<form id="data_form" method="post"  autocomplete="off" enctype='multiple/form-data'>
			...
			<div class="form-group row">
				<div class='col-md-12 text-right'>
					...
					<button type='button' id='sendCheckRelease' class='btn btn-sm btn-success'><b>Release To Finish Good</b></button>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-md-12">
					<table class='table'>
						...
						<tbody>
							<?php
							for ($i=1; $i <= $listData[0]->qty; $i++) { 
								$UNIQ = $listData[0]->id.'-'.$i;
								...
								echo "<tr>";
									echo "<td>".$check."</td>";
									// echo "<td>".$listData[0]->nama_product."</td>";
									echo "<td>".$i."</td>";
									if(empty($id_key)){
									echo "	<td>
									...
									echo "<td class='text-right'>
											<input type='hidden' name='detail[$i][id]' class='form-control input-md' value='" . $i . "'>
