...
class Outstanding_qc_model extends BF_Model{

  public function __construct(){
    parent::__construct();

    $this->ENABLE_ADD     = has_permission('Outstanding_QC.Add');
		$this->ENABLE_MANAGE  = has_permission('Outstanding_QC.Manage');
		$this->ENABLE_VIEW    = has_permission('Outstanding_QC.View');
		$this->ENABLE_DELETE  = has_permission('Outstanding_QC.Delete');
