<?php
$ENABLE_ADD     = has_permission('Approval_Quotation_1.Add');
$ENABLE_MANAGE  = has_permission('Approval_Quotation_1.Manage');
$ENABLE_VIEW    = has_permission('Approval_Quotation_1.View');
$ENABLE_DELETE  = has_permission('Approval_Quotation_1.Delete');
                ...
                ?>
                        ...
                        ?>
                            <tr>
                                ...
                                $btn_view = '<a href="' . base_url() . 'Approval_quotation/view_quotation1/' . $record->no_penawaran . '" class="btn btn-sm btn-info">View</a>';
                                ...
                                $btn_approval = '<a href="' . base_url() . 'Approval_quotation/approval_quotation_1/' . $record->no_penawaran . '" class="btn btn-sm btn-primary">Approval</a>';

                                $buttons = $btn_view;
                                if ($record->app_1 == '1' || $record->status !== '1') {
                                    $buttons = $btn_view;
                                } else {
                                    if ($ENABLE_MANAGE) {
