<?php
$ENABLE_ADD     = has_permission('Approval_Quotation_3.Add');
$ENABLE_MANAGE  = has_permission('Approval_Quotation_3.Manage');
$ENABLE_VIEW    = has_permission('Approval_Quotation_3.View');
$ENABLE_DELETE  = has_permission('Approval_Quotation_3.Delete');
                ...
                ?>
                        ...
                        ?>
                            <tr>
                                ...
                                $btn_view = '<a href="' . base_url() . 'Approval_quotation/view_quotation3/' . $record->no_penawaran . '" class="btn btn-sm btn-info">View</a>';
                                ...
                                $btn_approval = '<a href="' . base_url() . 'Approval_quotation/approval_quotation_3/' . $record->no_penawaran . '" class="btn btn-sm btn-primary">Approval</a>';

                                $buttons = $btn_view;
                                if ($record->app_3 == '1' || $record->app_2 !== '1') {
                                    $buttons = $btn_view;
                                } else {
                                    if ($ENABLE_MANAGE) {
