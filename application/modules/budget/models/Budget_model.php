...
class Budget_model extends BF_Model
{
     ...
     */
    protected $table_name = 'ms_coa_budget';
    protected $key        = 'id';
	...
	function GetBudget(){
		$this->db->select('a.*, b.nama, c.nm_divisi');
		$this->db->from('ms_coa_budget a');
		$this->db->join('ms_inventory_type b','a.coa=b.id_type');
		$this->db->join('divisi c','a.divisi=c.id_divisi','left');
