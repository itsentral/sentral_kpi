<?php
    $ENABLE_ADD     = has_permission('Production_Planning.Add');
    $ENABLE_MANAGE  = has_permission('Production_Planning.Manage');
    $ENABLE_VIEW    = has_permission('Production_Planning.View');
    $ENABLE_DELETE  = has_permission('Production_Planning.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
