                    ...
                    <td class="text-center">
                        ...
                        <?php if ($ENABLE_MANAGE): ?>
                            <a href="<?= site_url('kpi/edit/' . $row->id) ?>"
                                class="btn btn-warning btn-xs <?= ($row->is_realisasi == 1 || $row->is_realisasi == 2) ? 'btn-edit-locked' : '' ?>"
                                data-id="<?= $row->id ?>"
                                data-is-realisasi="<?= $row->is_realisasi ?>"
                                data-divisi="<?= htmlspecialchars($row->divisi_name) ?>"
                                title="Edit">
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit-locked', function(e) {
            e.preventDefault();
                ...
                html: `
                    <div style="text-align: center;">
                        <p class="text-danger">
                            ...
                            KPI ini sudah mulai direalisasi, sehingga <strong>indikator tidak dapat diubah</strong>.
                        </p>
                        <p style="font-size: 13px;">
                            Jika perlu melakukan perubahan, silakan hubungi administrator atau hapus data realisasi terlebih dahulu.
                        </p>
                    </div>
                `,
                icon: 'error',
