...
class Approval_po_non_product_model extends BF_Model
{
  ...
  public function data_side_approval_pr_material()
  {
    ...
    foreach ($query->result_array() as $row) {
      ...
      $approval_btn = '';
      if (has_permission('Approval_PO_Non_Product.Manage')) {
      ...
      //   <a href='approval_po_non_product/po_approval/" . $row['no_po'] . "' class='btn btn-sm btn-success'><i class='fa fa-check'></i></a>
