...
class Approval_penawaran_manager_model extends BF_Model
{
    ...
    public function __construct()
    {
        ...
        $this->ENABLE_ADD     = has_permission('Approval_Penawaran_Manager.Add');
        $this->ENABLE_MANAGE  = has_permission('Approval_Penawaran_Manager.Manage');
        $this->ENABLE_VIEW    = has_permission('Approval_Penawaran_Manager.View');
        $this->ENABLE_DELETE  = has_permission('Approval_Penawaran_Manager.Delete');
    }
    ...
    public function get_json_approval_manager()
    {
        ...
        foreach ($query->result_array() as $row) {
            ...
            // Aksi tombol
            $action = "<a href='" . base_url("approval_penawaran_manager/approval/{$row['id_penawaran']}") . "' class='btn btn-sm btn-success'><i class='fa fa-check-square-o'></i></a> ";
