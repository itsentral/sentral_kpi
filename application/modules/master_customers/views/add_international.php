					...
					<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-6">
											<input type="text" class="form-control" id="id_suplier" required name="id_suplier" readonly placeholder="Id Suplier">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
											  <select id="id_category_supplier" name="id_category_supplier" class="form-control select" required>
												...
												<option value="<?= $category->id_category_supplier?>"><?= ucfirst(strtolower($category->name_category_supplier))?></option>
												<?php } ?>
											  </select>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="name_suplier" required name="name_suplier" placeholder="Nama Suplier">
									</div>
								</div>
						...
						<div class="col-sm-6">
										<div class="form-group row">
											...
											<div class="col-md-6">
											  <select id="id_negara" name="id_negara" class="form-control select" required>
												<option value="">--Pilih--</option>
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
											  <input type="text" class="form-control" id="international_prov" required name="international_prov" placeholder="Profinsi">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-md-6">
											   <input type="text" class="form-control" id="international_kota" required name="international_kota" placeholder="Kota">
											</div>
										</div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_suplier/saveNewInternational';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
