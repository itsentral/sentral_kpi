 				...
 				<div class="input_fields_wrap2">
 					...
 					<div class="row">
 						<div class="form-group row">
 							...
 							<div class="col-md-6">
 								<input type="text" class="form-control" id="" readonly required name="id_categorry_customer" placeholder="Id Category Suplier">
 							</div>
 						</div>
 						<div class="form-group row">
 							<div class="col-md-4">
 							...
 							<div class="col-md-6">
 								<input type="text" class="form-control" id="" required name="name_category_customer" placeholder="Category Supliery">
 							</div>
 						</div>
 						<div class="form-group row" hidden>
 							...
 							<div class="col-md-6">
 								<input type="text" class="form-control" id="" required name="customer_code" placeholder="Category Suplier Code">
 							</div>
 						</div>
 					</div>
 				</div>
