...
<div class="box box-solid">	
	...
	<div class="box-body">
		<div class="box-body">	
			<div class="row">
			  <div class="col-md-12">
				<legend><h3 style="margin:0px !Important"><label>ID Inventory :<?= $result['id_category1']?></label></h3></legend>
				<legend><h3 style="margin:0px !Important"><label>Nama Iventory :<?= $result['nama']?></label></h3></legend>
			  <div>
			</div>
		</div>
	</div>
