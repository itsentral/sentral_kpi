<?php
    $ENABLE_ADD     = has_permission('Outgoing_Stok.Add');
    $ENABLE_MANAGE  = has_permission('Outgoing_Stok.Manage');
    $ENABLE_VIEW    = has_permission('Outgoing_Stok.View');
    $ENABLE_DELETE  = has_permission('Outgoing_Stok.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<div class="box">
	<div class="box-header">
		<?php if($ENABLE_ADD){ ?>
		<a class="btn btn-primary btn-sm" style='float:right;' href="<?= base_url('outgoing_stok/request') ?>" title="Request">Add Outgoing</a>
		<?php } ?>
    	<!-- <br> -->
