<?php 
    ...
    header('Content-Disposition: attachment; filename="HISTORY '.get_name('warehouse', 'nm_gudang', 'id', $gudang).' - '.strtoupper(get_name('new_inventory_4', 'nama', 'code_lv4', $material)).'.xls"');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>HISTORY <?=get_name('warehouse', 'nm_gudang', 'id', $gudang) ?> - <?=strtoupper(get_name('new_inventory_4', 'nama', 'code_lv4', $material)) ?></title>
</head>
<style media="screen">
