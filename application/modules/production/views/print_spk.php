...
$HTML_HEADER .= "<table class='gridtable2' border='0' width='100%' cellpadding='2'>";
    ...
    $HTML_HEADER .= "<tr>";
        ...
        $HTML_HEADER .= "<td class='header_style_alamat'>:</td>";
        $HTML_HEADER .= "<td class='header_style_alamat'>".$getData[0]['nama_product']."</td>";
    $HTML_HEADER .= "</tr>";
    $HTML_HEADER .= "<tr>";
        ...
        $HTML_HEADER .= "<td class='header_style_alamat'>:</td>";
        $HTML_HEADER .= "<td class='header_style_alamat'>".number_format($getData[0]['qty_produksi'])."</td>";
    $HTML_HEADER .= "</tr>";
    $HTML_HEADER .= "<tr>";
