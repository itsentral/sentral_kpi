...
class Spk_material_ftackle extends Admin_Controller
{
    //Permission
    protected $viewPermission 	= 'SPK_Produksi_F-Tackle.View';
    protected $addPermission  	= 'SPK_Produksi_F-Tackle.Add';
    protected $managePermission = 'SPK_Produksi_F-Tackle.Manage';
    protected $deletePermission = 'SPK_Produksi_F-Tackle.Delete';
   ...
   public function __construct()
    {
        ...
        $this->load->model(array('Spk_material_ftackle/spk_material_ftackle_model'
                                ));
    ...
    public function index(){
      ...
      history("View data spk produksi f-tackle");
      $this->template->title('SPK Produksi F-Tackle');
      $this->template->render('index',$data);
    }

    public function data_side_spk_material(){
  		$this->spk_material_ftackle_model->data_side_spk_material();
  	}
      ...
      if($this->input->post()){
        ...
        foreach ($Detail as $key => $value) {
          ...
          if($qty > 0){
            ...
            $ArrInsert[$key]['sts_request'] = 'Y';
            $ArrInsert[$key]['request_by'] = $this->id_user;
            $ArrInsert[$key]['request_date'] = $this->datetime;
            $ArrInsert[$key]['sts_subgudang'] = 'Y';
            $ArrInsert[$key]['subgudang_by'] = $this->id_user;
            $ArrInsert[$key]['subgudang_date'] = $this->datetime;
            $ArrInsert[$key]['id_gudang'] = 16;
    ...
    public function print_spk(){
      ...
      $data = array(
        ...
        'GET_DET_Lv4' => get_inventory_lv4(),
  		...
  		$this->load->view('print_spk2', $data);
  	}
    ...
    public function data_side_spk_reprint(){
  		$this->spk_material_ftackle_model->data_side_spk_reprint();
  	}
