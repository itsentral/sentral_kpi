...
// print_r($id_bq);
// exit;
$data_header        = $this->db->query("SELECT * FROM tr_invoice_payment_temp WHERE kd_pembayaran ='$kodebayar'")->row();
$data_detail        = $this->db->query("SELECT sum(total_bayar_idr) as total_bayar FROM tr_invoice_payment_detail_temp WHERE kd_pembayaran ='$kodebayar'")->row();
