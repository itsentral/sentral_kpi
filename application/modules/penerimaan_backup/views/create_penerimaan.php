                   ...
                   <div class="col-sm-6 form-horizontal">                       
                       ...
                       <div class="form-group ">
						...
						<div class="form-group ">
                            ...
                            <div class="col-sm-6" style="padding-top: 8px;">                              
                            <input type="text" name="biaya_pph" class="form-control input-sm maskMoney" id="biaya_pph" value="0" data-decimal='.' data-thousand='' data-precision='0' data-allow-zero=''>
                            </div>
                        </div>
						<div class="form-group ">
...
<div class="text-right">
  <div class="box active"> 
    <div class="box-body">
        <button class="btn btn-danger" onclick="kembali_inv()">
           <i class="fa fa-refresh"></i><b> Kembalix</b>
        </button>
 ...
 <script>
	...
	function kembali_inv(){
        window.location.href = base_url + active_controller+'/penerimaan';
    }
	...
	$(document).on('keyup', '#biaya_adm, #total_bank, #biaya_pph', function(){
		...
		var Total       = parseInt(biaya_adm)+parseInt(total_bank)+parseInt(biaya_pph);
...
//        $("#list_item_stok").DataTable({lengthMenu:[10,15,25,30]}).draw();		
	...
	function startmutasi(id,nm,avl,real,ret){
		var avl2 =numx(avl);
		var real2= numx(real);
		var ret2= numx(ret);
       //  Cek Ada Data Gagal
...
startmutasi('<?php echo $inv->no_invoice?>','<?php echo $inv->nm_customer?>','<?php echo $inv->total_invoice_idr?>','<?php echo $inv->sisa_invoice_idr?>');
</script>
