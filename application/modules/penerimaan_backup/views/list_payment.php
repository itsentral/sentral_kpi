				...
				<tbody>
					...
					?>
							<tr>
								...
								<td align="right"><?= number_format($record->jumlah_piutang, 2) ?></td>
								<td align="right"><?= number_format($record->biaya_pph_idr, 2) ?></td>
								<td align="right"><?= number_format($record->biaya_admin_idr, 2) ?></td>
								<td align="right"><?= number_format($record->jumlah_pembayaran_idr, 2) ?></td>
