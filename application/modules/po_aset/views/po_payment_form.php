...
<div class="nav-tabs-area">
    <div class="tab-content">
        <div class="tab-pane active" id="area">
            ...
            <?= form_open(base_url().'po_aset/save_payment_po',array('id'=>'frm_data','name'=>'frm_data','role'=>'form','class'=>'form-horizontal')) ?>
			    ...
			    <div class="form-group ">
				   ...
				   <label for="tgl_terima_invoice" class="col-sm-2 control-label">Tgl Terima Invoice</label>
                    <div class="col-sm-3">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-list"></i></span>
                        <input type="text" class="form-control tanggal" id="tgl_terima_invoice" name="tgl_terima_invoice" value="" readonly style="background:white;">
                        </div>
                    </div>
                </div>
				<?php
				$dpp=$datarpo->request_payment;
				?>
			    <div class="form-group ">
				   <label for="dpp" class="col-sm-2 control-label">DPP</label>
                    <div class="col-sm-3">
                        <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-list"></i></span>
                        <input type="text" class="form-control divide" id="dpp" name="dpp" value="<?php echo $datarpo->request_payment ?>" readonly onchange="cektotal()">
                        </div>
                    </div>
                </div>
					<div class="form-group ">
						...
						<div class="col-sm-3">
							...
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<?php
							echo form_dropdown('ppn',$datppn, $data->ppn, array('id'=>'ppn','class'=>'form-control readonly','required'=>'required','onchange'=>'cektotal()', 'readonly'=>'readonly'));
							?>
							</div>
						</div>
					...
					<div class="form-group ">
						...
						<div class="col-sm-3">
							<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<input type="text" class="form-control divide" id="t_biaya_lain" name="t_biaya_lain" value="0" onchange="cektotal()" readonly>
							</div>
							<div class="input-group">
								<?php
					...
					<div class="form-group ">
						...
						<div class="col-sm-4">
							<textarea readonly class="form-control" id="potongan_note" name="potongan_note" ></textarea>
						</div>
					</div>
					<div class="form-group ">
					...
					<div class="form-group ">
					   <label for="nilai_bayar" class="col-sm-2 control-label">Nilai Pembayaran</label>
						<div class="col-sm-3">
							<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<input type="text" class="form-control divide" id="nilai_bayar" name="nilai_bayar" value="0" readonly tabindex="-1">
							</div>
						</div>
					   <label for="top" class="col-sm-2 control-label">TOP (hari)</label>
						<div class="col-sm-3">
							<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<input type="text" class="form-control" id="top" name="top" value="0" readonly>
							</div>
						</div>
					</div>
					<div class="form-group ">
						...
						<div class="col-sm-3">
							...
							<span class="input-group-addon"><i class="fa fa-list"></i></span>
							<?php
							echo form_dropdown('bank',$datbank, '0', array('id'=>'bank','class'=>'form-control readonly','readonly'=>'readonly'));
							?>
							</div>
						</div>
					</div>
...
//			return false
        ...
        $.ajax({
            url: siteurl+"po_aset/save_payment_po",
            dataType : "json",
            type: 'POST',
            data: formdata,
