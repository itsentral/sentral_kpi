...
$additive_name   = (!empty($header))?$header[0]->additive_name:'';
    ...
    <div class="box-body">
		<form id="data-form" method="post"><br>
			<div class="form-group row">
				<div class="col-md-2">
					<label for="customer">Kegunaan Additive <span class='text-red'>*</span></label>
				</div>
				<div class="col-md-6">
					<input type="hidden" name="no_bom" value="<?=$no_bom;?>">
					<input type="text" name="additive_name" id='additive_name' required class='form-control input-md' placeholder='Kegunaan Additive' value="<?=$additive_name;?>">
				</div>
			</div>
			<br>
					...
					<table class='table table-striped table-bordered table-hover table-condensed' width='100%'>
						<thead>
							<tr class='bg-blue'>
								...
								<th class='text-center'>Additve Dari Total Resin (%)</th>
								<th class='text-center'>Pengurangan Resin (%)</th>
								<th class='text-center' style='width: 4%;'>#</th>
							</tr>
						</thead>
						<tbody>
              <?php
                ...
                if(!empty($detail)){
                    ...
                    echo "<tr class='header_".$val."'>";
                      ...
                      echo "</td>";
					  echo "<td align='left'>";
                      echo "<input type='text' name='Detail[".$val."][persen2]' class='form-control input-md autoNumeric4 qty' placeholder='Input % additve dari total Resin' value='".$valx['persen_add']."'>";
                      echo "</td>";
                      echo "<td align='left'>";
                      echo "<input type='text' name='Detail[".$val."][weight]' class='form-control input-md autoNumeric4 qty' placeholder='Input % pengurangan resin' value='".$valx['persen']."'>";
                      echo "</td>";
                      echo "<td align='left'>";
	...
	$(document).ready(function(){
	   ...
	   //delete part
		...
		$('#save').click(function(e){
			e.preventDefault();
			var additive_name		= $('#additive_name').val();
			...
			if(additive_name == '' ){
				swal({
					title	: "Error Message!",
					text	: 'Additive name empty, select first ...',
					type	: "warning"
				});
