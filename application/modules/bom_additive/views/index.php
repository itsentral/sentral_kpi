<?php
    $ENABLE_ADD     = has_permission('BOM_Additive.Add');
    $ENABLE_MANAGE  = has_permission('BOM_Additive.Manage');
    $ENABLE_VIEW    = has_permission('BOM_Additive.View');
    $ENABLE_DELETE  = has_permission('BOM_Additive.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
