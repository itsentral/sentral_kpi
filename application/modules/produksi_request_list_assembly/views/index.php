<?php
    $ENABLE_ADD     = has_permission('Request_List_Produksi_F-Tackle.Add');
    $ENABLE_MANAGE  = has_permission('Request_List_Produksi_F-Tackle.Manage');
    $ENABLE_VIEW    = has_permission('Request_List_Produksi_F-Tackle.View');
    $ENABLE_DELETE  = has_permission('Request_List_Produksi_F-Tackle.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<div class="box">
	...
	<?php if($ENABLE_ADD){ ?>
		<a class="btn btn-primary btn-sm" style='float:right;' href="<?= base_url('produksi_request_list_assembly/request') ?>" title="Request">Add Request</a>
		<?php } ?>
    	<!-- <br> -->
