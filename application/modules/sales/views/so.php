...
<div class="box">
	<div class="box-header">
			<?php if($ENABLE_ADD) : ?>
					<a class="btn btn-success btn-sm" href="<?= base_url('sales/add_so') ?>" title="Add"> <i class="fa fa-plus">&nbsp;</i>Add</a>
			<?php endif; ?>
...
<script type="text/javascript">
	...
	$(document).on('click', '.detail', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'sales/detail_sales_order/'+no_so,
			data:{'no_so':no_so},
	...
	$(document).on('click', '.delete', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'sales/delete_sales_order/'+no_so,
			  dataType : "json",
    ...
    function DataTables(){
  		var dataTable = $('#example1').DataTable({
  			...
  			"ajax":{
  				url : siteurl+'sales/data_side_sales_order',
  				type: "post",
  				data: function(d){
