<?php
$ENABLE_ADD     = has_permission('Cycletime_Custom.Add');
$ENABLE_MANAGE  = has_permission('Cycletime_Custom.Manage');
$ENABLE_VIEW    = has_permission('Cycletime_Custom.View');
$ENABLE_DELETE  = has_permission('Cycletime_Custom.Delete');
...
<div class="box">
	<div class="box-header">
		<div class="box-tool pull-right">
			<?php if ($ENABLE_ADD) : ?>
				<a class="btn btn-success btn-sm btn-custom" href="<?= base_url('cycletime_custom/add') ?>">Add</a>
			<?php endif; ?>
		</div>
	...
	<script type="text/javascript">
		...
		$(document).on('click', '.delete', function(e) {
			...
			swal({
				...
				function() {
					$.ajax({
						type: 'POST',
						url: siteurl + active_controller + '/delete_cycletime',
						dataType: "json",
						data: {
							'id': id
						},
		...
		function DataTables() {
			var dataTable = $('#example1').DataTable({
				...
				"ajax": {
					url: siteurl + active_controller + '/data_side_cycletime',
					type: "post",
					data: function(d) {
