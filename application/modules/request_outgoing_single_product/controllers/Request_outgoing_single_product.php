...
class Request_outgoing_single_product extends Admin_Controller
{
    //Permission
    protected $viewPermission 	= 'Request_Outgoing_Single_Product.View';
    protected $addPermission  	= 'Request_Outgoing_Single_Product.Add';
    protected $managePermission = 'Request_Outgoing_Single_Product.Manage';
    protected $deletePermission = 'Request_Outgoing_Single_Product.Delete';
   ...
   public function __construct()
    {
        ...
        $this->load->model(array(
          'Request_outgoing_single_product/Request_outgoing_single_product_model',
    ...
    public function index(){
      ...
      history("View index request outgoing single product");
      $this->template->title('Request Outgoing Single Product');
      $this->template->render('index');
    }

    public function data_side_request_produksi(){
  		$this->Request_outgoing_single_product_model->data_side_request_produksi();
  	}
