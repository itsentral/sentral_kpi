...
class Request_outgoing_single_product_model extends BF_Model{

  public function __construct(){
    parent::__construct();

    $this->ENABLE_ADD     = has_permission('Request_Outgoing_Single_Product.Add');
		$this->ENABLE_MANAGE  = has_permission('Request_Outgoing_Single_Product.Manage');
		$this->ENABLE_VIEW    = has_permission('Request_Outgoing_Single_Product.View');
		$this->ENABLE_DELETE  = has_permission('Request_Outgoing_Single_Product.Delete');
  ...
  public function data_side_request_produksi(){
    ...
    foreach($query->result_array() as $row){
      ...
      $edit	= "";
      if($this->ENABLE_MANAGE AND empty($row['outgoing_date'])){
