...
<script type="text/javascript">
	var url_add = siteurl+'purchase_order/create/';
	var url_edit = siteurl+'purchase_order/edit/';
	var url_delete = siteurl+'purchase_order/delete/';
	var url_view = siteurl+'purchase_order/view/';
</script>
