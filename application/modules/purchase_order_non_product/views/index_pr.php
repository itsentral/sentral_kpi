<?php
$ENABLE_ADD     = has_permission('Purchase_Order_Non_Product.Add');
$ENABLE_MANAGE  = has_permission('Purchase_Order_Non_Product.Manage');
$ENABLE_VIEW    = has_permission('Purchase_Order_Non_Product.View');
$ENABLE_DELETE  = has_permission('Purchase_Order_Non_Product.Delete');
...
<script type="text/javascript">
	...
	function proses_do() {
		...
		// window.location.href = siteurl + "purchase_order_non_product/proses/" + uri3 + "?param=" + param;
						...
						success: function(data) {
							if (data.list_id == "0") {
								...
								$.ajax({
									...
									dataType: 'json',
									success: function(result) {
										window.location.href = siteurl + "purchase_order_non_product/proses/?param=" + data.list_id;
									}
								});
							}
						},
