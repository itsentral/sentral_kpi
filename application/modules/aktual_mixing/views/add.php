    ...
    <div class="box-body">
		...
		<div class="form-group row">
			<div class="col-md-12 text-danger text-bold">
				<input type="checkbox" name='check_close' id='check_close' value='1'> Close All Input Aktual Produksi Mixing <i><u>dengan checklist status produksi menjadi close</u></i>
			</div>
		</div>
