...
class Outstanding_qc_ftackle extends Admin_Controller
{
  //Permission
  protected $viewPermission   = 'Outstanding_QC_Ftackle.View';
  protected $addPermission    = 'Outstanding_QC_Ftackle.Add';
  protected $managePermission = 'Outstanding_QC_Ftackle.Manage';
  protected $deletePermission = 'Outstanding_QC_Ftackle.Delete';
  ...
  public function __construct()
  {
    ...
    $this->load->model(array(
      'Outstanding_qc_ftackle/Outstanding_qc_ftackle_model'
    ));
  ...
  public function index()
  {
    ...
    history("View index outstanding QC F-tackle");
    $this->template->title('Quality Control / Outstanding QC F-Tackle');
    $this->template->render('index');
  }

  public function data_side_outstanding_qc()
  {
    $this->Outstanding_qc_ftackle_model->data_side_outstanding_qc();
  }
