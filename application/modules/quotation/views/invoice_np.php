		...
		<div class="form-group row" >
			 <table class="table table-bordered" width="100%" id="list_item_stok">
              ...
              <tbody>
                  ...
                  $invoice = $this->db->query("SELECT a.*, b.name_customer as nm_customer FROM tr_invoice_np_header a
                  ...
                  ?>
						  <tr>
							  ...
							  ?>
								<center>
									<button id="btn-<?php echo $vs->no_invoice?>" class="btn btn-warning btn-sm" type="button" onclick="startmutasi('<?php echo $vs->id_invoice?>', '<?php echo $vs->no_invoice?>','<?php echo addslashes($vs->nm_customer) ?>','<?php echo $vs->total_invoice_idr?>','<?php echo $vs->sisa_invoice_idr?>')">
										Pilih
									</button>
								</center>
							  <?php 
