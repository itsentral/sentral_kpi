...
$p_project           = (!empty($header[0]->project)) ? $header[0]->project : $project;
        ...
        <form id="data-form" method="post"><br>
                ...
                <div class="col-md-4">
                    <select id="id_customer" name="id_customer" class="form-control input-md chosen-select">
                        ...
                        <?php foreach ($customer as $val => $value) {
                            $sel = (isset($id_customer) && $value['id_customer'] == $id_customer) ? 'selected' : '';
                        ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="project" id="project" class='form-control input-md' required placeholder='Project Name' value="<?= $p_project; ?>">
                </div>
            </div>
