                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="date" class="form-control" id="tanggal" onkeyup required name="tanggal" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->tgl_penawaran : null ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="col-sm-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-8">
                                                    <select id="id_customer" name="id_customer" class="form-control select2 get_pic_customer" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class='col-sm-6'>
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-md-8'>
                                                    <input type="text" name="term_of_payment" id="" class="form-control" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->top : null ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-sm-6'>
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-md-8' id="">
                                                    <input type="text" name="project" id="" class="form-control" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->project : null ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class='col-sm-6'>
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-md-8'>
                                                    <select name="action" id="" class="form-control select_action">
                                        ...
                                        <div class='col-sm-6'>
                                            <div class='form-group row'>
                                                ...
                                                <div class='col-md-8'>
                                                    <textarea name="keterangan_reject" id="" cols="30" rows="3" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <tbody id="list_item_mutasi">
                            ...
                            if (isset($results['data_penawaran_detail'])) {
                                foreach ($results['data_penawaran_detail'] as $penawaran_detail) {
                                    ...
                                    $price_after_disc = (($penawaran_detail->harga_satuan * $penawaran_detail->qty) - $penawaran_detail->diskon_nilai);
									...
									<tr>
										...
										<td>
											<input type="number" name="qty_' . $penawaran_detail->id_penawaran_detail . '" value="' . $penawaran_detail->qty . '" class="form-control text-right qty_' . $penawaran_detail->id_penawaran_detail . '" onchange="hitung_all(' . $penawaran_detail->id_penawaran_detail . ')">
										</td>
										<td class="text-right">' . number_format($penawaran_detail->harga_satuan, 2) . '</td>
										...
										<td>
											...
											<input type="text" class="form-control diskon_nilai_' . $penawaran_detail->id_penawaran_detail . '" name="diskon_nilai_' . $penawaran_detail->id_penawaran_detail . '" id="" value="' . $penawaran_detail->diskon_nilai . '" onchange="hitung_all(' . $penawaran_detail->id_penawaran_detail . ')">
										</td>
										<td class="text-right">
											' . number_format($price_after_disc, 2) . '
										</td>
										<td class="text-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group " style="padding-top:15px;">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="persen_ppn" class="form-control input-sm text-right persen_ppn" id="" value="<?= (isset($results['data_penawaran'])) ? $results['data_penawaran']->ppn : null ?>">
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" name="nilai_ppn" class="form-control input-sm text-right nilai_ppn" id="total" value="<?= (isset($results['data_penawaran'])) ? number_format($total_all * $results['data_penawaran']->ppn / 100, 2) : null ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6"></div>
                ...
                */
                ...
                $(document).on('change', '.persen_ppn', function() {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(result) {
                            $('.nilai_ppn').val(number_format(result.hasil, 2));
                            $('.persen_ppn').val(number_format(ppn_persen, 2));
                ...
                $(document).on('change', '.nilai_ppn', function() {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(result) {
                            $('.persen_ppn').val(number_format(result.hasil, 2));
