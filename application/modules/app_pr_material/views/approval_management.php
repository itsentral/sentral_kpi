<?php
$ENABLE_ADD     = has_permission('Approval_PR_Material_Management.Add');
$ENABLE_MANAGE  = has_permission('Approval_PR_Material_Management.Manage');
$ENABLE_VIEW    = has_permission('Approval_PR_Material_Management.View');
$ENABLE_DELETE  = has_permission('Approval_PR_Material_Management.Delete');
?>
<style type="text/css">
	thead input {
		width: 100%;
	...
	<script type="text/javascript">
		...
		function DataTables(costcenter = null, product = null) {
			var dataTable = $('#example1').DataTable({
				...
				"ajax": {
					url: siteurl + active_controller + 'data_side_approval_pr_material_management',
					type: "post",
					data: function(d) {
