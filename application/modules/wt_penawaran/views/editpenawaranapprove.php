...
<div class="box box-primary">
    <div class="box-body">
        ...
        <?php } ?>
								...
								<table class='table table-bordered table-striped'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        echo	"</select>
                                            ...
                                            <td id='diskon_$loop'><input type='text' value='$dt_spk->diskon' class='form-control'  id='used_diskon_$loop' required name='dt[$loop][diskon]' onkeyup='HitungTotal($loop)' readonly></td>
                    ...
                    <a class="btn btn-danger btn-sm" href="<?= base_url('/wt_penawaran/') ?>"  title="Kembali">Kembali</a>
                    </center>
		</form>		  
	</div>
</div>	
