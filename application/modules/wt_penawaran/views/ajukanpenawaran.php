								...
								<table id="example1" class='table table-bordered table-striped'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        echo	"</select>
                                            ...
                                            <td id='qty_$loop'><input type='text' value='$dt_spk->qty' class='form-control input-sm' id='used_qty_$loop' required name='dt[$loop][qty]'></td>
                                            ...
                                            <td id='stok_tersedia_$loop'><input type='text' value='$dt_spk->stok_tersedia' class='form-control input-sm' id='used_stok_tersedia_$loop' required name='dt[$loop][stok_tersedia]'></td>
                                            ...
                                            <td id='diskon_$loop'><input type='text' value='$dt_spk->diskon' class='form-control'  id='used_diskon_$loop' required name='dt[$loop][diskon]'></td>
                                            <td id='freight_cost_$loop'><input type='text' value='$dt_spk->freight_cost' class='form-control input-sm' id='used_freight_cost_$loop' required name='dt[$loop][freight_cost]'></td>
                                            <td id='total_harga_$loop'><input type='text' value='$dt_spk->total_harga' class='form-control input-sm' id='used_total_harga_$loop' required name='dt[$loop][total_harga]' readonly></td>
                                            <td align='center'>
...
$(document).on('click', '.ajukan', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'wt_penawaran/FormApproval/'+id,
			data:{'id':id},
