...
<div class="box box-primary">
    <div class="box-body">
        ...
        <?php } ?>
                    ...
                    <center>
                    <button type="submit" class="btn btn-success btn-sm" name="save" id="simpan-com"><i class="fa fa-save"></i>Ubah Status Terkirim</button>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'wt_penawaran/SaveStatusTerkirim';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
