...
<div class="box box-primary">
    <div class="box-body">
		<form id="data-form" method="post">
			...
			<div class="row">
		<center><label for="customer" ><h3></h3></label></center>
		<div class="col-sm-12">
		    <div class="col-sm-6">
        ...
        <div class="col-md-12">
		    <div class='col-sm-6'>
		        <div class='form-group row'>
			        <div class='col-md-4'>
				        <label for='email_customer'>Keterangan Request Approval</label>
			        </div>
                    <div class='col-md-8'>
                        <textarea id='keterangan' name='keterangan' cols='50'><?= $hd->keterangan ?></textarea>
                    </div>
			    </div>
		    </div>
		    <div class='col-sm-6'>
		        <div class='form-group row'>
			        <div class='col-md-4'>
				        <label for='email_customer'>Status Approval</label>
			        </div>
			        <div class='col-md-8' id="">
		   ...
		   <div class="col-md-12">
		    <div class='col-sm-6'>
		        <div class='form-group row'>
			        <div class='col-md-4'>
				        <label for='email_customer'>Keterangan Approve</label>
			        </div>
                    <div class='col-md-8'>
                        <textarea id='keterangan_approve' name='keterangan_approve' cols='50'></textarea>
                    </div>
			    </div>
		    </div>
		    <div class='col-sm-6'>
							...
							<table class='table table-bordered table-striped'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        <tr id='tr_$loop'>
                                            <td>$loop</td>
                                            <td>
                                                <select id='used_no_surat_$loop' name='dt[$loop][no_surat]' data-no='$loop' onchange='CariDetail($loop)' class='form-control select' disabled required>
                                                    <option value=''>-Pilih-</option>";	
                                        ...
                                        echo	"</select>
                                            ...
                                            <td id='qty_$loop'>
											<input type='hidden' value='$dt_spk->nama_produk' class='form-control input-sm' readonly id='used_nama_produk_$loop' required name='dt[$loop][nama_produk]' readonly>
											<input type='hidden' value='$dt_spk->diskon_compare' class='form-control'  id='used_compare_diskon_$loop' required name='dt[$loop][compare_diskon]'>
											<input type='hidden' value='$dt_spk->nilai_diskon' class='form-control'  id='used_nilai_diskon_$loop' required name='dt[$loop][nilai_diskon]' readonly>
											<input type='text' value='$dt_spk->qty' class='form-control input-sm' id='used_qty_$loop' required name='dt[$loop][qty]' onblur='HitungTotal($loop)' readonly>
											</td>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'wt_penawaran/SaveApprovePenawaran';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
